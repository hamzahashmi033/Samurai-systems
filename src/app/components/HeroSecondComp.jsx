  ...
  return (
    <div className="bg-Black xs:overflow-hidden h-screen font-ClashDisplay flex items-center  px-8">
      ...
      >
        ...
        <div className="flex xs:flex-col   sm:flex-row 2xl:mt-16 sm:gap-[40px]  lg:mt-2 justify-between xs:ml-20 lg:ml-10 2xl:py-10 2xl:px-8 xs:py-2 xs:px-6  ">
          {Icons.map((icon) => (
        ...
        <div className="xs:mt-10 overflow-x-hidden  2xl:h-[84px] 2xl:mt-32 xs:w-[50vw] sm:w-[80vw] lg:w-[90vw] 2xl:w-[50vw] mx-auto ">
          <Carousel
